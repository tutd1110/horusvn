    ...
    <div id="filter-block">
        <el-row :gutter="10" style="margin-bottom: 15px;">
            <el-col :span="3" style="padding-top: 21px">
                <el-badge :value="totalPAssigned" class="item" :hidden="totalPAssigned === 0">
                    <!-- <el-button style="width: 100%" type="success" v-on:click="onRedirect()">Goto Personal Assigned</el-button> -->
                    <el-button style="width: 100%" type="success" v-on:click="onRedirect()">Bug Cá Nhân Bị Gán</el-button>
                </el-badge>
            </el-col>
        ...
        <el-scrollbar :height="heightScrollbar" class="custom-scrollbar">
            <template v-for="(record, idx2) in dataSource" :key="idx2">
                <el-row :gutter="2" class="table-task-body">
                    ...
                    <el-col :span="getColSpan('assigned_department_id')">
                        <el-card class="box-card" shadow="hover" style="text-align: center;">
                            <el-select
...
const CreateSelbox = () => {
    //create select boxes
    axios.get('/api/task_assignments/psc-selbox')
    .then(response => {
        ...
        totalPAssigned.value = response.data.count_p_assigned;
...
const columns = ref([
    ...
    { title: "Project", key: "project_id", span: 3 },
    { title: "Department", key: "assigned_department_id", span: 2 },
    { title: "Task", key: "task_id", span: 4 },
    { title: "Code", key: "task_id_input", span: 1 },
    { title: "Level", key: "level", span: 1 },
    { title: "Description", key: "description", span: 4 },
...
const showReportModal = () => {
    modalReportRef.value.ShowWithReportMode(formState.value, 'psc-total');
}
...
const search = () => {
    ...
    axios.post('/api/task_assignments/psc-issues', formState.value)
    .then(response => {
...
const onRedirect = () => {
    ...
    const newPath = '/issues/personal-assigned';
