    ...
    <div id="filter-block">
        <el-row :gutter="10" style="margin-bottom: 15px;">
            <el-col :span="2" style="padding-top: 21px">
                <el-badge :value="totalPSelfCreated" class="item" :hidden="totalPSelfCreated === 0">
                    <!-- <el-button style="width: 100%" type="success" v-on:click="onRedirect()">Goto Personal SCreated</el-button> -->
                    <el-button style="width: 100%" type="success" v-on:click="onRedirect()">Bug Cá Nhân Đã Gán</el-button>
                </el-badge>
            </el-col>
            <div class="flex-grow" />
            <el-col :span="5">
...
const CreateSelbox = () => {
    //create select boxes
    axios.get('/api/task_assignments/pa-selbox')
    .then(response => {
        ...
        totalPSelfCreated.value = response.data.count_p_self_created;
...
const columns = ref([
    ...
    { title: "Description", key: "description", span: 6 },
...
const showReportModal = () => {
    modalReportRef.value.ShowWithReportMode(formState.value, 'pa-total');
}
...
const search = () => {
    ...
    axios.post('/api/task_assignments/pa-issues', formState.value)
    .then(response => {
...
const onRedirect = () => {
    ...
    const newPath = '/issues/personal-self-created';
