...
/**
 * Petition Edit Request
*/
class PetitionEditRequest extends ApiBaseRequest
{
    /**
    ...
    public function rules()
    {
        ...
        */
        ...
        if (in_array($input_data['type'], [4])) {
            $rules += array('start_time_change' => ['nullable', 'date_format:H:i:s']);
            $rules += array('end_time_change' => ['nullable', 'date_format:H:i:s', 'after:start_time']);
        }
    ...
    public function messages()
    {
        ...
        if (in_array($input_data['type'], [4])) {
            $msgs += array('start_time_change.required' => __('MSG-E-004'));
            $msgs += array('start_time_change.date_format' => __('MSG-E-005'));

            $msgs += array('end_time_change.required' => __('MSG-E-004'));
            $msgs += array('end_time_change.date_format' => __('MSG-E-005'));
            $msgs += array('end_time_change.after' => __('MSG-E-013'));
        }
    ...
    */
    public function attributes()
    {
        return [
            ...
            'start_time_change' => 'Thời gian bắt đầu',
            'end_time_change' => 'Thời gian kết thúc',
